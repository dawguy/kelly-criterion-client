...
while(true){
if((i <= self__.level)){
var links_28791 = (update[i]).forward;
if((i < x__$2.forward.length)){
(x__$2.forward[i] = (links_28791[i]));
} else {
x__$2.forward.push((((i < links_28791.length))?(links_28791[i]):null));
}

if((i < links_28791.length)){
(links_28791[i] = x__$2);
} else {
links_28791.push(x__$2);
}
...
var links_28794 = (update[i_28793]).forward;
if((x__$1 === (((i_28793 < links_28794.length))?(links_28794[i_28793]):null))){
(links_28794[i_28793] = (x__$1.forward[i_28793]));

var G__28795 = (i_28793 + (1));
i_28793 = G__28795;
continue;
} else {
