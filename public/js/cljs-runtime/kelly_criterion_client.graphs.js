...
kelly_criterion_client.graphs.power_profile = (function kelly_criterion_client$graphs$power_profile(splits){
var size = (300);
...
var G__6152 = new cljs.core.Keyword(null,"duration","duration",1444101068).cljs$core$IFn$_invoke$arity$1(d);
return (x.cljs$core$IFn$_invoke$arity$1 ? x.cljs$core$IFn$_invoke$arity$1(G__6152) : x.call(null,G__6152));
})).y((function (d){
var G__6153 = new cljs.core.Keyword(null,"power","power",-937852079).cljs$core$IFn$_invoke$arity$1(d);
return (y.cljs$core$IFn$_invoke$arity$1 ? y.cljs$core$IFn$_invoke$arity$1(G__6153) : y.call(null,G__6153));
}));
...
kelly_criterion_client.graphs.appendDurations = (function kelly_criterion_client$graphs$appendDurations(splits){
return (function kelly_criterion_client$graphs$appendDurations_$_helper(arr,rem,sum){
if(((1) < cljs.core.count(rem))){
return kelly_criterion_client$graphs$appendDurations_$_helper(cljs.core.conj.cljs$core$IFn$_invoke$arity$2(arr,cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(cljs.core.first(rem),new cljs.core.Keyword(null,"pos","pos",-864607220),sum)),cljs.core.rest(rem),(sum + new cljs.core.Keyword(null,"duration","duration",1444101068).cljs$core$IFn$_invoke$arity$1(cljs.core.first(rem))));
} else {
...
kelly_criterion_client.graphs.workout = (function kelly_criterion_client$graphs$workout(s){
var splits = kelly_criterion_client.graphs.appendDurations(s);
var size = (400);
var durations = cljs.core.map.cljs$core$IFn$_invoke$arity$2(new cljs.core.Keyword(null,"duration","duration",1444101068),splits);
var powers = cljs.core.map.cljs$core$IFn$_invoke$arity$2(new cljs.core.Keyword(null,"power","power",-937852079),splits);
var endPos = cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p1__6154_SHARP_){
return (new cljs.core.Keyword(null,"pos","pos",-864607220).cljs$core$IFn$_invoke$arity$1(p1__6154_SHARP_) + new cljs.core.Keyword(null,"duration","duration",1444101068).cljs$core$IFn$_invoke$arity$1(p1__6154_SHARP_));
}),splits);
...
return new cljs.core.PersistentVector(null, 3, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"svg","svg",856789142),new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"viewBox","viewBox",-469489477),["0 0 ",cljs.core.str.cljs$core$IFn$_invoke$arity$1(size)," ",cljs.core.str.cljs$core$IFn$_invoke$arity$1(size)].join('')], null),cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p__6155){
var map__6178 = p__6155;
var map__6178__$1 = cljs.core.__destructure_map(map__6178);
var duration = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__6178__$1,new cljs.core.Keyword(null,"duration","duration",1444101068));
var power = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__6178__$1,new cljs.core.Keyword(null,"power","power",-937852079));
var seq = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__6178__$1,new cljs.core.Keyword(null,"seq","seq",-1817803783));
var pos = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__6178__$1,new cljs.core.Keyword(null,"pos","pos",-864607220));
