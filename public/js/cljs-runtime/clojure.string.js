...
var r = (new RegExp(re.source,(function (){var G__26390 = "g";
var G__26390__$1 = (cljs.core.truth_(re.ignoreCase)?[G__26390,"i"].join(''):G__26390);
var G__26390__$2 = (cljs.core.truth_(re.multiline)?[G__26390__$1,"m"].join(''):G__26390__$1);
if(cljs.core.truth_(re.unicode)){
return [G__26390__$2,"u"].join('');
} else {
return G__26390__$2;
}
})()));
...
while (G__26406__i < G__26406__a.length) {G__26406__a[G__26406__i] = arguments[G__26406__i + 0]; ++G__26406__i;}
  args = new cljs.core.IndexedSeq(G__26406__a,0,null);
} 
...
while(true){
if((!((coll__$1 == null)))){
var G__26413 = sb.append(cljs.core.str.cljs$core$IFn$_invoke$arity$1(cljs.core.first(coll__$1)));
var G__26414 = cljs.core.next(coll__$1);
sb = G__26413;
coll__$1 = G__26414;
continue;
} else {
...
var G__26424 = cljs.core.pop(v__$1);
v__$1 = G__26424;
continue;
} else {
return v__$1;
...
var G__26460 = s__$1.substring((index + cljs.core.count(m)));
var G__26461 = (limit__$1 - (1));
var G__26462 = cljs.core.conj.cljs$core$IFn$_invoke$arity$2(parts,s__$1.substring((0),index));
s__$1 = G__26460;
limit__$1 = G__26461;
parts = G__26462;
continue;
